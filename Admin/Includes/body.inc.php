            ...
            <header id="fh5co-header-section">
                <div class="container">
                    <div class="nav-header">
                        ...
                        <h1 id="fh5co-logo"><a href="../Admin/index.php"><strong><i class="fab fa-grunt"></i> Rally Javali</strong></a></h1>
                        </nav>
                    </div>
                </div>
...
function botper()
{
    ...
    <footer>
        <div id="footer" class="fh5co-copyright text-center" style="position: relative; padding-bottom: 0px">
            <p>
                &copy; 2016 Free HTML5 template. All Rights Reserved.
                <span>Designed with <i class="icon-heart"></i> by <a href="http://freehtml5.co/" target="_blank">FreeHTML5.co</a>
								Demo Images by <a href="http://unsplash.com/" target="_blank">Unsplash</a></span>
